...
export default function RegisterPage() {
  ...
  const { user, signUp, loading, error, setIsLoginPage } = useAuth();
  const router = useRouter();

  // Indiquer que nous sommes sur une page d'inscription (considérée comme login)
  useEffect(() => {
    setIsLoginPage(true);
    return () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await signUp(email, password, fullName, role, school);
